...
def get_reranker() -> Reranker:
    ...
    :class:`IdentityReranker` khi Jina lỗi. Nếu chưa cấu hình JINA_API_KEY,
    giữ nguyên thứ hạng RRF thay vì xếp hạng lại theo từ khóa.
    """
    ...
    if not api_key:
        logger.warning(
            "JINA_API_KEY is not configured; preserving semantic RRF ranking."
        )
